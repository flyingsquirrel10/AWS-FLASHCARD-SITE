  ...
  return (
    ...
    <div className="paddings innerWidth description-container">
      <div className="flexColStart descrption-head">
        <h2 alt="AWS Exam Study Guide" className="orangeText primaryText">
          Flashcards Description
        </h2>
      </div>
  
      <p alt="overview" className="flashcard-intro">
        The flashcards are broken into sections that most closely match the AWS
        Certified Developer Associate Exam but all the material can be applied
        across the AWS Cloud Practitioner Exam, AWS Certified Solutions
        Architect - Associate, and the AWS Certified Developer Associate Exam.
        <br />
        <br />
        The flashcards are designed with the student in mind. They are short
        and concise, giving detailed explanations to why an answer is
        correct.
      </p>
      ...
      <div className="grid-container">
        {flashcardDescriptionData.map((flashcard, index) => (
          <div key={flashcard.header} className="faq-section">
            <h2>{flashcard.header}</h2>
            {flashcard.subheaders.map((subheader) => (
              <Accordion key={subheader.subheader} title={subheader.subheader}>
